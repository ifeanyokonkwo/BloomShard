 ...
 * This file demonstrates how to integrate Bloomshard with a web frontend
 */

// For React/Vue/Angular applications
export class BloomshardClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new BloomshardClient(provider, contractAddress);
